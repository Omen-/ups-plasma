...
<section class="container">
  <div class="row">
    <div class="col-md-7 col-sm-12 content-section">
      ...
      <div class="newslist-separator">
      </div>
    <div class="col-md-4 col-sm-12 content-section">
      <h1 style="white-space: nowrap; overflow: hidden" class="page-header">Dates importantes</h1>
      <br><br>
